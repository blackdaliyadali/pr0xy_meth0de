...
def banner():
	...
	print " .-----------------------------.           "
	print " |  Hi Hackers                 |           "
	print " |  Tool   : pr0xy_meth0de     |"
	print " |  Author : @blackdalyadali   |           "
	print " |           Jai Hind          |           "
	print " '-----------------------------'           "
	print " "
...
def helpl():
	banner()
	print ("For single domain   : python pr0xy_meth0de .py -p http://yourserver.com/ ")
	print ("For multiple domain : cat live-domain.txt | xargs -n1 -p50 python pr0xy_meth0de .py --parse  " )
